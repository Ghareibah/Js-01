...
var cartBoxContent = `
                      <img src="AED{productImg}" alt="" class="cart-img">
                      <div class="detail-box">
                          <div class="cart-product-title">AED{title}</div>
                          <div class="cart-price">AED{price}</div>
                          <input type="number" value="1" class="cart-quantity">
                      </div>
                          <i class='bx bxs-trash alt cart-remove'></i>`;
cartShopBox.innerHTML = cartShopBox;
